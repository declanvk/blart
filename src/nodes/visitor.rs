...
pub trait Visitable<K: AsBytes, T, const NUM_PREFIX_BYTES: usize, H: NodeHeader<NUM_PREFIX_BYTES>> {
    ...
    fn super_visit_with<V: Visitor<K, T, NUM_PREFIX_BYTES, H>>(&self, visitor: &mut V) -> V::Output;
...
impl<K: AsBytes, T, const NUM_PREFIX_BYTES: usize, H: NodeHeader<NUM_PREFIX_BYTES>> Visitable<K, T, NUM_PREFIX_BYTES, H> for OpaqueNodePtr<K, T, NUM_PREFIX_BYTES, H> {
    fn super_visit_with<V: Visitor<K, T, NUM_PREFIX_BYTES, H>>(&self, visitor: &mut V) -> V::Output {
...
impl<K: AsBytes, T, const NUM_PREFIX_BYTES: usize, H: NodeHeader<NUM_PREFIX_BYTES>, N: Node<NUM_PREFIX_BYTES> + Visitable<K, T, NUM_PREFIX_BYTES, H>> Visitable<K, T, NUM_PREFIX_BYTES, H> for NodePtr<NUM_PREFIX_BYTES, N> {
    fn super_visit_with<V: Visitor<K, T, NUM_PREFIX_BYTES, H>>(&self, visitor: &mut V) -> V::Output {
        let inner = self.read();
...
impl<K: AsBytes, T, const NUM_PREFIX_BYTES: usize, H: NodeHeader<NUM_PREFIX_BYTES>> Visitable<K, T, NUM_PREFIX_BYTES, H> for InnerNode4<K, T, NUM_PREFIX_BYTES, H> {
    fn super_visit_with<V: Visitor<K, T, NUM_PREFIX_BYTES, H>>(&self, visitor: &mut V) -> V::Output {
...
impl<K: AsBytes, T, const NUM_PREFIX_BYTES: usize, H: NodeHeader<NUM_PREFIX_BYTES>> Visitable<K, T, NUM_PREFIX_BYTES, H> for InnerNode16<K, T, NUM_PREFIX_BYTES, H> {
    fn super_visit_with<V: Visitor<K, T, NUM_PREFIX_BYTES, H>>(&self, visitor: &mut V) -> V::Output {
        combine_inner_node_child_output(self.iter(), visitor)
    }
...
impl<K: AsBytes, T, const NUM_PREFIX_BYTES: usize, H: NodeHeader<NUM_PREFIX_BYTES>> Visitable<K, T, NUM_PREFIX_BYTES, H> for InnerNode48<K, T, NUM_PREFIX_BYTES, H> {
    fn super_visit_with<V: Visitor<K, T, NUM_PREFIX_BYTES, H>>(&self, visitor: &mut V) -> V::Output {
        combine_inner_node_child_output(self.iter(), visitor)
    }
...
impl<K: AsBytes, T, const NUM_PREFIX_BYTES: usize, H: NodeHeader<NUM_PREFIX_BYTES>> Visitable<K, T, NUM_PREFIX_BYTES, H> for InnerNode256<K, T, NUM_PREFIX_BYTES, H> {
    fn super_visit_with<V: Visitor<K, T, NUM_PREFIX_BYTES, H>>(&self, visitor: &mut V) -> V::Output {
        combine_inner_node_child_output(self.iter(), visitor)
    }
...
impl<K: AsBytes, T, const NUM_PREFIX_BYTES: usize, H: NodeHeader<NUM_PREFIX_BYTES>> Visitable<K, T, NUM_PREFIX_BYTES, H> for LeafNode<K, T, NUM_PREFIX_BYTES, H> {
    fn super_visit_with<V: Visitor<K, T, NUM_PREFIX_BYTES, H>>(&self, visitor: &mut V) -> V::Output {
...
pub trait Visitor<K: AsBytes, V, const NUM_PREFIX_BYTES: usize, H: NodeHeader<NUM_PREFIX_BYTES>>: Sized {
...
fn combine_inner_node_child_output<K: AsBytes, T, const NUM_PREFIX_BYTES: usize, H: NodeHeader<NUM_PREFIX_BYTES>, V: Visitor<K, T, NUM_PREFIX_BYTES, H>>(

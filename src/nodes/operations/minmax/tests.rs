use crate::{
    ...
    LeafNode, NodePtr, OpaqueNodePtr, VariableKeyHeader,
};

#[test]
fn leaf_tree_min_max_same() {
    let root: OpaqueNodePtr<Box<[i32; 4]>, String, 16, VariableKeyHeader<16>> =
...
fn large_tree_same_length_keys_min_max() {
    ...
    let mut root: OpaqueNodePtr<Box<[u8]>, usize, 16, VariableKeyHeader<16>> =
